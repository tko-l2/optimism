...
func TestMigration(t *testing.T) {
	...
	migRes := migrateL2(t, workdir, deployCfg, forkBlockNumber)
	...
	l1BlockHash, ok := deployCfg.L1StartingBlockTag.Hash()
...
func migrateL2(t *testing.T, workdir string, deployConfig *genesis.DeployConfig, forkBlockNumber uint64) *genesis.MigrationResult {
	migCfg := &migration_action.Config{
		...
		L1URL:                 config.l1URL,
		StartingL1BlockNumber: forkBlockNumber,
		L2DBPath:              workdir,
		DryRun:                false,
	}
